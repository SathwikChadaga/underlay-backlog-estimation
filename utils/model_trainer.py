...
class modelTrainer():
    ...
    def batch_step_transformer(self, model, src_batch, tgt_batch_input, tgt_batch_output, y_batch, optimizer):
        model.train()
        ...
        # forward 
        y_pred = model(src_batch, tgt_batch_input)
    ...
    def get_train_batch_transformer(self, src_train, tgt_train_input, tgt_train_outpt, y_train, batch_size = None, randomize = False):
        ...
        return src_train[batch_indices,:], tgt_train_input[batch_indices,:], tgt_train_outpt[batch_indices,:], y_train[batch_indices,:]
